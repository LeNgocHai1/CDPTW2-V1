        ...
        <div class="row ">
            <div class="col-sm-4">
                <div class="pic p-0 img_sp">
                    <img src="{{ asset('upload/' . $product->productImage) }}" alt="" style="" class="xzoom"
                        xoriginal="{{ asset('upload/' . $product->productImage) }}">
                </div>
                <div class="img_sp_chitiet xzoom-thums">
                    <a href="{{ asset('upload/' . $product->productImage) }}" class="card">
                        <img src="{{ asset('upload/' . $product->productImage) }}"
                            xpreview="{{ asset('upload/' . $product->productImage) }}" class="xzoom-gallery">
                    </a>
                    @if (isset($prodetail->productImage1))
                        <a href="{{ asset('upload/' . $product->productImage1) }}" class="card">
                            <img src="{{ asset('upload/' . $product->productImage1) }}" class="xzoom-gallery">
                        </a>
                    @endif
                    @if (isset($prodetail->productImage2))
                        <a href="{{ asset('upload/' . $product->productImage2) }}" class="card">
                            <img src="{{ asset('upload/' . $product->productImage2) }}" class="xzoom-gallery">
                        </a>
                    @endif
                    @if (isset($prodetail->productImage3))
                        <a href="{{ asset('upload/' . $product->productImage3) }}" class="card">
                            <img src="{{ asset('upload/' . $product->productImage3) }}" class="xzoom-gallery">
                        </a>
                    @endif
                </div>
            ...
            <div class="col-sm-8">
                ...
                <div class="like-share mt-4 ml-5">
                    <iframe src="https://www.facebook.com/plugins/like.php?href=https://www.facebook.com/tdc.fit"
