        ...
        <ul class="navbar-nav" style="float: right;">
            @guest
                <li class="nav-item cart-icon">
                    ...
                    <a class="nav-link btn btn-success" href="{{ url('List-Carts') }}"><i
                            class="fas fa-cart-arrow-down"></i> <b>Giỏ hàng</b>
                        @if (Session::has('Cart') != null)
                            <span style="width: 25px;" id="total-quanty-show"
                                class="badge badge-success ml-3">{{ Session::get('Cart')->totalQuanty }}</span>
                        @else
                        ...
                        <div id="change-item-cart">
                            @if (Session::has('Cart') != null)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="si-text">
                                                        <div class="product-selected">
                                                            <b>{{ number_format($item['productInfo']->listPrice) }}₫ x
                                                                {{ $item['quanty'] }}</b>
                                                    ...
                                                    <td class="si-close">
                                                        <h4><a class=""
                                                                ...
                                                                role="button"><i class="far fa-times"></i></a></h4>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                ...
                                <div class="select-button">
                                    <a href="{{ url('List-Carts') }}" class="primary-btn view-card"> <b>XEM GIỎ HÀNG</b>
                                    </a>
            ...
            @else
                <li class="nav-item cart-icon">
                    ...
                    <a class="nav-link btn btn-success" href="{{ url('List-Carts') }}"><i
                            class="fas fa-cart-arrow-down"></i> <b>Giỏ hàng</b></span>
                        @if (Session::has('Cart') != null)
                            <span style="width: 25px;" id="total-quanty-show"
                                class="badge badge-success ml-3">{{ Session::get('Cart')->totalQuanty }}</span>
                        @else
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link btn btn-info dropdown-toggle" id="navbarDropdown" role="button" href="#"
    ...
    <nav class="navbar hr  ">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-content">
                ...
                <h6 class="dropdown-item" href="">CSKH: <a href=""
                        class="btn-outline-info">+0834474225</a> <i class="fas fa-angle-right"></i> </h6>
