                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-3" id="choose-products">
                            <div class=""><img
                                    src="http://static.360buyimg.com/master-of-loader/pc/img/mother-board-icon.82595f5e.svg"
                                    style="vertical-align: middle;  width:80px;margin-right: 30px"></div>
                            <div class="">
                                <p style="color: #4A235A;"><b>Vui lòng chọn linh kiện</b></p>
                            </div>
                        </div>
                        <div class="col-3">
                            <!-- Button to Open the Modal -->
                            <a class="btn btn-primary" onclick="ViewPro({{ $category->categoryID }})" data-toggle="modal"
                                data-target="#myModal">
