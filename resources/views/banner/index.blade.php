...
<div class="container jumbotron   border border-success">
    ...
    <table class="table">
      ...
      <tbody>
               <tr> 
                   <td><div class="" ><img src="../public/upload/banner.jpg" alt="Product Image" style="width: 300px;"></div></td>
           ...
           <tr>
            <td><div class="" ><img src="../public/upload/banner1.jpg" alt="Product Image" style="width: 300px;"></div></td>
            
            <td> 
              <a class="button btn btn-success" href=""><i class="fas fa-tools"></i>  Sửa</a>
              <form class="d-inline-block " action="{{ route('banner.destroy') }}" method="post" >
                {{ csrf_field() }}
                @method('DELETE')
